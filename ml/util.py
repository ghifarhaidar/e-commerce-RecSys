...
def data_preprocessing(reviews_file,meta_file,train_file,valid_file,test_file,user_vocab,
                       item_vocab,cate_vocab,sample_rate=0.5,valid_num_ngs=4,
                       test_num_ngs=49,is_history_expanding=True,
):
